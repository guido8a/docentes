    ...
    <g:form class="form-horizontal" name="frmEscuela" role="form" action="save" method="POST">
        ...
        <div class="form-group ${hasErrors(bean: escuelaInstance, field: 'codigo', 'error')} ">
            <span class="grupo">
                ...
                <div class="col-md-6">
                    <g:textField name="codigo" maxlength="8" required="" class="allCaps form-control required" value="${escuelaInstance?.codigo}"/>
                </div>
        ...
        <div class="form-group ${hasErrors(bean: escuelaInstance, field: 'facultad', 'error')} ">
            <span class="grupo">
                ...
                <div class="col-md-6">
                    <g:select id="facultad" name="facultad.id" from="${docentes.Facultad.list()}" optionKey="id" required="" value="${escuelaInstance?.facultad?.id}" class="many-to-one form-control"/>
                </div>

    ...
    <g:form class="form-horizontal" name="frmRecomendacion" role="form" action="save" method="POST">
        ...
        <div class="form-group ${hasErrors(bean: recomendacionInstance, field: 'descripcion', 'error')} ">
            <span class="grupo">
                ...
                <div class="col-md-10">
                    <g:textArea name="descripcion" cols="40" rows="5" maxlength="255" required="" style="resize: none"
                                class="form-control required" value="${recomendacionInstance?.descripcion}"/>
                </div>
